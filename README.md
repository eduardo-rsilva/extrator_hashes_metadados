...
* **🌍 Arquivos Geográficos (KML):** A biblioteca nativa `xml.etree.ElementTree` processa a árvore XML do mapa iterando sobre os nós, extraindo o total exato de `<coordinates>` e a totalização bruta de vértices originais mapeados no arquivo.
...
> SILVA, Eduardo R. **Extrator de Hashes e Metadados (ERS-IC/SP-NIC)**. Versão 4.6.0. São Paulo, SP: GitHub, 2026. Disponível em: <https://github.com/eduardo-rsilva/extrator_hashes_metadados/releases>. Acesso em: [Data de Acesso].

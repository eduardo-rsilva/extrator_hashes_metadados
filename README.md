# Extrator de Hashes e Metadados (ERS-IC/SP-NIC) - v.5.2.1

🚀 **[CLIQUE AQUI PARA BAIXAR A VERSÃO MAIS RECENTE (v.5.2.1)](https://github.com/eduardo-rsilva/extrator_hashes_metadados/releases/download/v.5.2.1/Extrator_ERS-IC-SP-NIC_v5.2.1.zip)**
...
> SILVA, Eduardo R. **Extrator de Hashes e Metadados (ERS-IC/SP-NIC)**. Versão 5.2.1. São Paulo, SP: GitHub, 2026. Disponível em: <https://github.com/eduardo-rsilva/extrator_hashes_metadados/releases>. Acesso em: [Data de Acesso].

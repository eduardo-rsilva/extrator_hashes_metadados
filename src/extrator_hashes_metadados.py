...
class JanelaHashes(QWidget):
    ...
    def mostrar_sobre(self):
        ...
        conteudo_html = (
            ...
            "<li><b>Detecção ADS:</b> Varredura automática por Alternate Data Streams (dados ocultos) em partições NTFS.</li>"
            "<li><b>Validação de Assinatura:</b> Checagem de certificados Authenticode em executáveis (EXE/DLL/SYS).</li>"
            ...
            "<h3>🔓 Transparência e Auditoria:</h3>"
            "<ul>"

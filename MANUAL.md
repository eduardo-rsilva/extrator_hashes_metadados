# 📖 Guia de Operação - Extrator de Hashes e Metadados (ERS-IC/SP-NIC) - v.7.1.0
...
1. [CLIQUE AQUI PARA BAIXAR A VERSÃO MAIS RECENTE (v.7.1.0)](https://github.com/eduardo-rsilva/extrator_hashes_metadados/releases/download/v.7.1.0/Extrator_ERS-IC-SP-NIC_v7.1.0.zip) 

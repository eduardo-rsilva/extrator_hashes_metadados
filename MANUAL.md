# 📖 Guia de Operação - Extrator de Hashes e Metadados (ERS-IC/SP-NIC) - v.5.2.0
...
1. [CLIQUE AQUI PARA BAIXAR A VERSÃO MAIS RECENTE (v.5.2.0)](https://github.com/eduardo-rsilva/extrator_hashes_metadados/releases/download/v.5.2.0/Extrator_ERS-IC-SP-NIC_v5.2.0.zip) 
